...
function Verify() {
  ...
  return (
    <div className="relative isolate mt-40 max-w-xl mx-auto border border-gray-500 rounded-xl">
        ...
        <div className="pb-6">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-4">
              ...
              <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                  <button className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">
                    Verify you are above 18
                  </button>
                </div>
              </div>
              <div className="mt-2">
      ...
      <div className="mt-6 flex items-center justify-end gap-x-6 px-6 pb-6">
        <button
          onClick={() => handleActiveComponent("chat")}
